\chapter[Suporte Tecnológico]{Suporte Tecnológico}\label{chap:suptec}
...
\begin{itemize}
    \item Filtros Colaborativos, de Conteúdo e Híbridos: modelos do \mycitetext{pathak2020}, e do 
    \mycitetext{ahmed2024};
    \item Rede Neural Convolucional: modelo do \mycitetext{datai2020};
    \item Rede Neural Recorrente: modelo do \mycitetext{bazdyrev2019};
    \item Máquina Restrita de Boltzmann: modelo do \mycitetext{musib2023}, e
    \item \textit{Autoencoder}: modelo do \mycitetext{rocky2024}.
\end{itemize}
E para base de dados para a prova de conceito
foi selecionada uma porcentagem da base \mycitetext{parashar2023}.
